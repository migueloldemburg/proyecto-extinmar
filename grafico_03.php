...
while( $row=$tipoExtintor->array->fetch_array() ){
	...
	$cant_x_mes = array();
	$cant_x_mes[] = $obj->get_categorias_cantidad('01', date('Y'), $row['id']) + $obj->get_categorias_cantidad('02', date('Y'), $row['id']) + $obj->get_categorias_cantidad('03', date('Y'), $row['id']) + $obj->get_categorias_cantidad('04', date('Y'), $row['id']) + $obj->get_categorias_cantidad('05', date('Y'), $row['id']) + $obj->get_categorias_cantidad('06', date('Y'), $row['id']) + $obj->get_categorias_cantidad('07', date('Y'), $row['id']) + $obj->get_categorias_cantidad('08', date('Y'), $row['id']) + $obj->get_categorias_cantidad('09', date('Y'), $row['id']) + $obj->get_categorias_cantidad('10', date('Y'), $row['id']) + $obj->get_categorias_cantidad('11', date('Y'), $row['id']) + $obj->get_categorias_cantidad('12', date('Y'), $row['id']);
...
$graph->xaxis->SetTickLabels(array('Año 2018'));
...
$graph->title->Set(utf8_decode("GRAFICAS ANUALES  AÑO(".date('Y').")"));
