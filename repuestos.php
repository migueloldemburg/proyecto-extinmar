...
<body>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" name="cantidad" onkeypress="return isNumber(event)" placeholder="Cantidad">
						</div>
						<div class="form-group">
	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-sm-12">
				<h3 class="text-center">Repuestos Extinmar C.A</h3>
			</div>
		</div>
		<div class="row">
			<div class="col-sm-offset-2 col-sm-8">
				<div class="panel panel-info">
					<div class="panel-heading">Repuestos
						<button class="btn btn-sm btn-default pull-right" data-toggle="modal" data-target="#confServicio" data-accion="agregar" data-tipo="Repuesto"><span class="glyphicon glyphicon-plus"></span> Agregar</button></div>
							...
							<?php
								...
								if($ser_categoria->obtener_servicios('repuesto')){
									while($row=$ser_categoria->array->fetch_assoc()){
										...
										echo "<td>";
										echo "<button class='btn btn-xs btn-warning' data-toggle='modal' data-target='#confServicio' data-accion='editar' data-id='".$row['id']."' data-tipo='Repuesto'><span class='glyphicon glyphicon-pencil'></span></button>";
