					...
					<div class="panel-content">
						<div class="well">
							<form class="form-inline" id="buscar_notas_por_estado">
							    ...
							    <button class="btn btn-info btn-xs">Buscar</button>
							     <button class="btn btn-warning btn-xs" onclick="imprimir_reporte_03()">Imprimir</button>
							     <button class="btn btn-primary btn-xs" onclick="imprimir_reporte_03(true)">PDF</button>
							</form>
						</div>
