		...
		<div class="row">
			...
			?>
				<div class="alert alert-danger text-center">
					<h3 class="text-center">Nota de Orden #51548 no pudo ser procesada.</h3>
				    <button class="btn btn-xs btn-default" onclick="location.href='enviarNotificacionCliente.php?id_nota=<?php echo $_GET['id_nota'] ?>'">Procesar nuevamente</button>
					<a href="ordenesEnTaller.php" class="btn btn-xs btn-success">Volver a notas En Taller</a href="ordenesEnTaller.php"> 
				</div>
			<?php 
				}
