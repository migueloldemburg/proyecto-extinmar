				...
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" name="departamento" placeholder="Nombre de dep&oacute;sito">
						</div>
						<div class="form-group">
							<label for="nombre">Pasillo:</label>
							<input type="text" class="form-control" name="pasillo" placeholder="Nombre de pasillo">
						</div>
					</div>
