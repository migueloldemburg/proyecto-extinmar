...
function restaurarr(){
	alertify.confirm("Confirmar", "Desea realizar la restauracion de la Base de Datos?",
		function(){
			$.ajax({
	            type: "POST",
...
function imprimir_reporte_01(){	
	...
	$.ajax({
		type: "POST",
		url: "imprimir.php",
		data: {from, to, id_ubicacion, accion:'imprimir_reporte_01'},
		success: function(datos){
			var win = window.open(' ', 'popimpr');
			win.document.write( datos );
			win.document.close();
...
function imprimir_reporte_02(){	
	var id_ext_categoria = $("select[name=id_ext_categoria").val()

	$.ajax({
		type: "POST",
		url: "imprimir.php",
		data: {id_ext_categoria, accion:'imprimir_reporte_02'},
		success: function(datos){
			var win = window.open(' ', 'popimpr');
			win.document.write( datos );
			win.document.close();
...
function imprimir_reporte_03(){	
	...
	$.ajax({
		type: "POST",
		url: "imprimir.php",
		data: {id_nota, from, to, estado, accion:'imprimir_reporte_03'},
		success: function(datos){
			var win = window.open(' ', 'popimpr');
			win.document.write( datos );
			win.document.close();
...
function imprimir_reporte_04(){	
	var id_ext_categoria = $("select[name=id_ext_categoria").val()

	$.ajax({
		type: "POST",
		url: "imprimir.php",
		data: {id_ext_categoria, accion:'imprimir_reporte_04'},
		success: function(datos){
			var win = window.open(' ', 'popimpr');
			win.document.write( datos );
			win.document.close();
...
function imprimir_reporte_05(){	

	$.ajax({
		type: "POST",
		url: "imprimir.php",
		data: {accion:'imprimir_reporte_05'},
		success: function(datos){
			var win = window.open(' ', 'popimpr');
			win.document.write( datos );
			win.document.close();
...
function imprimir_reporte_06(id_ext){	
	$.ajax({
		type: "POST",
		url: "imprimir.php",
		data: {id_ext, accion:'imprimir_reporte_06'},
		success: function(datos){
			var win = window.open(' ', 'popimpr');
			win.document.write( datos );
			win.document.close();
